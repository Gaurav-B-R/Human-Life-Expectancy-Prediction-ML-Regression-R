...
# Top 5 variables influencing the Target variable (Life Expectancy) are:
sort(coef(final_model), decreasing = TRUE)
# 1. Country_France (24.4553)
# 2. Country_Canada (23.1823)
# 3. Country_Republic.of.Korea (23.1026)
# 4. Status (-22.9140)
# 5. Country_Israel (22.8590)